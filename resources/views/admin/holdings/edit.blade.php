<x-layouts.app :title="__('Editar holding')">

    <div class="space-y-6">
        <div>
            <p class="az-eyebrow mb-2">Estructura corporativa</p>
            <h2 class="az-title text-3xl font-semibold">Editar Holding</h2>
            <p class="mt-2 az-muted">
                Modificar los datos operativos y financieros del holding.
            </p>
        </div>

        <div class="az-card p-6">
            <form method="POST" action="{{ route('admin.holdings.update', $holding) }}" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="gang_id" class="az-input">
                            ...
                            @foreach($gangs as $gang)
                                <option value="{{ $gang->id }}" @selected(old('gang_id', $holding->gang_id) == $gang->id)>
                                    {{ $gang->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name', $holding->name) }}" class="az-input" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="legal_name" value="{{ old('legal_name', $holding->legal_name) }}" class="az-input">
                    ...
                    <div>
                        ...
                        <input type="text" name="sector" value="{{ old('sector', $holding->sector) }}" class="az-input">
                    ...
                    <div>
                        ...
                        <input type="text" name="contact_name" value="{{ old('contact_name', $holding->contact_name) }}" class="az-input">
                    ...
                    <div>
                        ...
                        <input type="text" name="contact_phone" value="{{ old('contact_phone', $holding->contact_phone) }}" class="az-input">
                    ...
                    <div>
                        ...
                        <input type="email" name="contact_email" value="{{ old('contact_email', $holding->contact_email) }}" class="az-input">
                    ...
                    <div>
                        ...
                        <select name="trust_level" class="az-input" required>
                            @for($i = 1; $i <= 5; $i++)
                                <option value="{{ $i }}" @selected(old('trust_level', $holding->trust_level) == $i)>
                                    {{ $i }}
                                </option>
                            @endfor
                        </select>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="default_commission_percent" value="{{ old('default_commission_percent', $holding->default_commission_percent) }}" class="az-input" required>
                    ...
                    <div>
                        ...
                        <select name="status" class="az-input" required>
                            <option value="active" @selected(old('status', $holding->status) === 'active')>Activo</option>
                            <option value="inactive" @selected(old('status', $holding->status) === 'inactive')>Inactivo</option>
                            <option value="blocked" @selected(old('status', $holding->status) === 'blocked')>Bloqueado</option>
                        </select>
                ...
                <div>
                    ...
                    <textarea name="notes" rows="5" class="az-input">{{ old('notes', $holding->notes) }}</textarea>
